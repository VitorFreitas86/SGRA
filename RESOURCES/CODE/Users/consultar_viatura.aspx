<%@ Page Title="" Language="C#" MasterPageFile="~/acessos.Master" AutoEventWireup="true" CodeBehind="consultar_viatura.aspx.cs" Inherits="WebApplication10.Users.consultar_viatura" %>
        ...
        <ContentTemplate>
            ...
            <div class="div_background_withe">
                <asp:Panel ID="Panel_header" runat="server" Width="100%" Style="padding-top: 15px;">
                    <asp:Label ID="Label7" runat="server" Text="Histórico de Pedidos de Circulação de Viaturas" CssClass="header_letras2"></asp:Label>
                ...
                <div class="roundCorner" id="GridView_div">
                    <asp:GridView ID="GridView_viatura" runat="server" Width="100%" GridLines="None" ShowFooter="true"
                        AutoGenerateColumns="false" DataKeyNames="idviatura" AllowPaging="True" PageSize="20" OnPageIndexChanging="GridView_viatura_PageIndexChanging" OnRowCommand="GridView_viatura_RowCommand" OnRowDataBound="GridView_viatura_RowDataBound" OnDataBound="GridView_viatura_DataBound">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="titleGridRoundDir" FooterStyle-CssClass="footerGridRoundDir">
                                <ItemTemplate>
                                    <tr>
                                        <td colspan="13">
                                            <asp:Panel ID="Panel_renovacao" runat="server" Visible="false" CssClass="chil_grid_panel_viatura_renovacao">
                                                <asp:GridView ID="GridView_renovacao" OnRowCreated="GridView_child_RowCreated" runat="server" Width="99.7%" GridLines="Horizontal" BorderWidth="0"
                                                    AutoGenerateColumns="false" DataKeyNames="idviatura_renovacao" Visible="true" EmptyDataText="Não existem pedidos de Renovações">
                            ...
                            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ControlStyle-BorderWidth="0">
                                <ItemTemplate>
                                    <tr>
                                        <td colspan="13">
                                            <asp:Panel ID="Panel_segunda_via"  runat="server" Visible="false" CssClass="chil_grid_panel_viatura">
                                                <asp:GridView ID="GridView_segunda_via" runat="server" Width="99.8%" GridLines="Horizontal" BorderWidth="0"
                                                    AutoGenerateColumns="false" DataKeyNames="idviatura_via" EmptyDataText="Não existem pedidos de 2º Via">
                                                    <RowStyle BackColor="#FFFFFF" BorderWidth="0" Font-Names="Ubuntu" Font-Size="12px" ForeColor="#0d4465" />
                                                    <Columns>
                                                        <asp:TemplateField SortExpression="points" HeaderStyle-CssClass="child_grid_header " ItemStyle-HorizontalAlign="Center">
                                                            <HeaderTemplate>Registo</HeaderTemplate>
