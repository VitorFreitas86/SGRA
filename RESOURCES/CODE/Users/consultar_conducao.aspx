<%@ Page Title="" Language="C#" MasterPageFile="~/acessos.Master" AutoEventWireup="true" CodeBehind="consultar_conducao.aspx.cs" Inherits="WebApplication10.Users.consultar_conducao" %>
        ...
        <ContentTemplate>
            ...
            <div class="div_background_withe">
                <asp:Panel ID="Panel_header" runat="server" Width="100%" Style="padding-top: 15px;">
                    <asp:Label ID="Label7" runat="server" Text="Histórico de Pedidos de Condução" CssClass="header_letras2"></asp:Label>
                ...
                <div class="roundCorner" id="GridView_div">
                    <asp:GridView ID="GridView_conducao" runat="server" Width="100%"
                        OnRowDataBound="GridView_conducao_RowDataBound" GridLines="None" ShowFooter="true"
                        AutoGenerateColumns="false" DataKeyNames="idconducao" OnRowCommand="GridView_conducao_RowCommand" AllowPaging="True" OnPageIndexChanging="GridView_conducao_PageIndexChanging" PageSize="20" OnDataBound="GridView_conducao_DataBound">
                        ...
                        <PagerTemplate><%-- cellpadding="0" cellspacing="0"--%>
                        ...
                        <Columns>
                            <asp:TemplateField SortExpression="points" HeaderStyle-CssClass="titleGrid" ItemStyle-HorizontalAlign="Center"
                                FooterStyle-CssClass="footerGridRoundEsq">
                            ...
                            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="titleGridRoundDir_BTN" FooterStyle-CssClass="footerGridRoundDir">
                                <ItemTemplate>
                                    <tr>
                                        <td colspan="8">
                                            <asp:Panel ID="Panel_segunda_via" runat="server" Visible="false" CssClass="chil_grid_panel_conducao_via">
                                                <asp:GridView ID="GridView_segunda_via" runat="server" Width="100.1%" GridLines="Horizontal" BorderWidth="0"
                                                    AutoGenerateColumns="false" DataKeyNames="idsegunda_via_conducao" OnRowCreated="GridView_child_RowCreated">
                            ...
                            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <tr>
                                        <td colspan="8">
                                            <asp:Panel ID="Panel_renovacao" runat="server" Visible="false" CssClass="chil_grid_panel_reno">
                                                <asp:GridView ID="GridView_renovacao" runat="server" Width="100.1%" GridLines="Horizontal" BorderWidth="0"
                                                    AutoGenerateColumns="false" DataKeyNames="idsegunda_via_conducao" OnRowCreated="GridView_child_RowCreated">
                                                    <RowStyle BackColor="#FFFFFF" BorderWidth="0" Font-Names="Ubuntu" Font-Size="12px" ForeColor="#0d4465" />
                                                    <Columns>
                                                        <asp:TemplateField SortExpression="points" HeaderStyle-CssClass="child_grid_header " ItemStyle-HorizontalAlign="Center">
